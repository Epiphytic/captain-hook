...
- Session registration system with three mechanisms: interactive prompt, CLI registration, and HOOKWISE_ROLE env var fallback
- File-backed human decision queue for cross-process communication
- Unix domain socket IPC for supervisor agent communication at /tmp/hookwise-<team-id>.sock
...
- CLI commands:
  ...
  - `init` -- Initialize .hookwise/ directory in a repository
...
- Custom role definitions via .hookwise/roles.yml
...
[0.1.0]: https://github.com/epiphytic/hookwise/releases/tag/v0.1.0
